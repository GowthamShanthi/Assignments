...
public class Assignment5_Collections_MapList {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		

// Student Details - Storing First row items in first map
...
//Student3 table
HashMap<String, String> student3 = new HashMap<String,String>();

student3.put("Name","Twenty Two");
student3.put("Age","Twenty One");
...
// Store all the student details in single list
...
// Storing all the employee details to single list 
...
Map<String,List<Map<String, String>>> consolidteddata= new HashMap<>();

consolidteddata.put("StudentDetails", StudentDetailsList);


consolidteddata.put("EmployeeDetails", empList);

consolidteddata.put("ProductDetails", productList );


System.out.println("The supplier detail is \t"+consolidteddata.get("ProductDetails").get(1).get("Supplier")); 
